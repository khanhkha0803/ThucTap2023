	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="../index3.html" class="brand-link">
				<img src="../dist/img/npp.jpg" alt="Kshop Logo" class="brand-image img-circle elevation-3" style="opacity: 0.8" />
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<a href="../producer/index.php?action=listproducer" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Danh sách</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="../producer/index.php?action=addproducer" class="nav-link">
										<i class="far fa-circle nav-icon"></i>

    ...
    switch ($action) {
      ...
      case 'addproduct':
            ...
            if(isset($_POST['add'])&&($_POST['add'])){
              ...
              insert_product($namep , $price,$quantity,$hinh ,$info, $idcg,$idpc);
              ...
              if(!empty($file_name)){
                ...
                if(in_array($file_extension, $loai_file)){
                  if($file_size <= 1000000000){
                    ...
                    update_product($idp,$namep, $price ,$quantity, $generated_file_name, $info ,$idcg,$idpc);
                ...
                update_product($idp,$namep, $price ,$quantity, $file_name, $info ,$idcg,$idpc);
                header('Location: index.php?action=listproduct');
              }
          }
